...
print("TW +random环境。adv=global，10W数据，20+200 SHARE fix_last hh")
...
def update_dynamic_shared_Random(num_depots, max_car_load, dynamic, distance, next_idx, current_idx, upper, lower):  # 加了参数：访问的前一个点。
    """
...
if __name__ == '__main__':
    ...
    # todo ：全1.1规划的效率区别？[假装自己是提前规划路径，1.1倍估计，1.1倍扣电量]
